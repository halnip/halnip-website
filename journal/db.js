...
const HALNIP_DB = (function () {
  ...
  const SEED_VERSION  = '2026-06-09-05';   // ← SEED更新時にここを書き換える（旧キャッシュを自動上書き）
